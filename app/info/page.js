...
const FAQ = [
  ...
  { question: "落とし物はどこに届ければ良いか", answer: "お近くにいる赤い法被を着た梅苑祭実行委員もしくは受付に届けてください。" },
  { question: "出たゴミはどこに捨てれば良いか", answer: "お近くにあるゴミ箱に捨てていただいて構いません。" },
  { question: "エレベーターの使用してよいか", answer: "基本的に使用はできません。ただし、足の不自由な方や急な体調不良などの場合は使用していただいても問題ありません。" },
]
